...
class TestClass {
	/*
	 * This block comment should contain any class-wide or interface-wide
	...
	/**
	 * Longer block comment to describe method. method sing() sings a song!
	 */
	protected static void sing() {
		/*
		 * Loops through and sings all the verses of the song Code over the 80
		 * char limit can be formatted using CTRL + SHIFT + F and it always
		 * looks horrible.
		 */
