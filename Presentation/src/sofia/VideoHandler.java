...
public class VideoHandler {
	 ...
	 * 
	 * @param nGroup
	 *            - The group this handler should place videos in
	 */
	 ...
	 * 
	 * @param x
	 *            - The x coordinate for the top left of the video relative to
	 *            the groups origin.
	 * 
	 * @param y
	 *            - The y coordinate for the top left of the video relative to
	 *            the group's origin.
	 * 
	 * @param width
	 ...
	 * 
	 * @param sourcefile
	 *            - Absolute filepath of the video as a string.
	 * 
	 * @param autoplay
	 *            - If true video plays as soon as created.
	 * 
	 * @param loop
	 *            - If true video loops to beginning once it ends.
	 */
	...
	/**
	 * Causes a video handled by the handler to change playback position.
	 * 
	 * @param videoId
	 *            - The ID of the video to be played.
	 * 
	 * @param percent
	 *            - The time in the video to move playback to as a percentage of
	 *            the total time.
	 */
	...
	/**
	 * Causes a video handled by the handler to change size
	 * 
	 * @param videoId
	 *            - The ID of the video to be played.
	 * 
	 * @param nWidth
	 *            - The new width for the video.
	 */
	...
	/**
	 * Causes a video handled by the handler to change location
	 * 
	 * @param videoId
	 *            - The ID of the video to be played.
	 * 
	 * @param nx
	 *            - The new x location in pixels
	 * @param ny
	 *            - The new y location in pixels
	 */
	...
	/**
	 * Causes a video handled by the handler to change visibility
	 * 
	 * @param videoId
	 *            - The ID of the video to be played.
	 * 
	 * @param visible
	 *            - The new visibility setting as a boolean.
	 */
	public void setVisible(int videoId, boolean visible) {
		if (videoId < videos.size() && videoId >= 0) {
			videos.get(videoId).setVisible(visible);
		} else
			System.out.println("Video id not recognised");
	}
