...
public class ImageHandler {
	...
	public void drawImage(float xPos, float yPos, String filepath, double scaleX, double scaleY, float rotation,
		...
		try {
			...
			/*
			 * Image filtering section. Initially declares an Effect variable
			 * for the bottom of the tree of effects. Then loops through all the
			 * varargs (if any) and makes new effects based on the enum entered,
			 * then adds the effect to the image. If a secondary effect is
			 * entered, then the input for this effect is the previous effect.
			 */
