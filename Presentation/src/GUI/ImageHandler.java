...
public class ImageHandler {
	 ...
	 * 
	 * */
	public void drawImage(float xPos, float yPos, String filepath, double d, double e, float rotation, boolean vFlip,
			boolean hFlip, double cropRight, double cropLeft, double cropDown, double cropUp) {
		...
		Rectangle2D cropImage = new Rectangle2D(x + cropLeft, y + cropDown, width - cropRight - cropLeft, height
				- cropUp - cropDown);
