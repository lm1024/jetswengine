...
public class DummyGUI extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		thisGraphicsHandler.drawLine(100f, 200f, 220f, 200f, new Color(0, 0, 1, 1), Shadow.HEAVY, Shading.HORIZONTAL,
				new Color(1, 0, 0, 1), new Color(0, 0, 0, 1));

		thisGraphicsHandler.drawLine(230f, 200f, 350f, 200f, new Color(0, 0, 1, 1), Shadow.HEAVY, Shading.NONE,
				new Color(1, 0, 0, 1), new Color(0, 0, 0, 1));
		...
		// thisGraphicsHandler.drawPolygon(new Color(0, 1, 1, 1), new Double[] {
		// 120.0, 270.0, 140.0, 310.0, 110.0, 350.0,
		// 160.0, 320.0 }, -50, -50, new Color(1, 1, 1, 0.5));

		// thisGraphicsHandler.drawChord(100, 400, 50, 50, 45, 200, new Color(1,
		// 0, 1, 0.8), new Color(0, 1, 1, 1));
		// thisGraphicsHandler.drawArc(250, 400, 50, 50, 100, 100, new Color(0,
		// 1, 1, 1), new Color(0, 1, 1, 1));
		...
		thisTextHandler.addStringToBuffer("Number 1 ", Font.getDefault().getName(), 20, "#ff0000ff", "#ffaa00ff",
				TextAttribute.BOLD);
		thisTextHandler.addStringToBuffer("Number 2 ", "Calibri", 20, "#ff00ff00", "#ffaa00ff", TextAttribute.BOLD,
				TextAttribute.ITALIC, TextAttribute.UNDERLINE, TextAttribute.STRIKETHROUGH, TextAttribute.SUPERSCRIPT,
